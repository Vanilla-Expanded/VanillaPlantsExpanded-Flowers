...
{
    public class WorkGiver_GrowerFlowers_Harvest : WorkGiver_GrowerFlowers
    {
        ...
        public override bool HasJobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            Zone_BloomingFlowerZone zone_Growing = c.GetZone(pawn.Map) as Zone_BloomingFlowerZone;
