...
{
    public class WorkGiver_GrowerFlowers_Sow : WorkGiver_GrowerFlowers
    {
        ...
        protected override bool ExtraRequirements(IPlantToGrowSettable settable, Pawn pawn)
        {
            ...
            Zone_BloomingFlowerZone zone_Growing = settable as Zone_BloomingFlowerZone;
            IntVec3 c;
        ...
        public override Job JobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            Zone_BloomingFlowerZone zone_Growing = c.GetZone(map) as Zone_BloomingFlowerZone;
            bool flag = false;
            ...
            if (thing2 != null)
            {
                ...
                if (plant2 != null && pawn.CanReserveAndReach(plant2, PathEndMode.Touch, Danger.Deadly, 1, -1, null, forced) && !plant2.IsForbidden(pawn))
                {
                    ...
                    {
                        Zone_BloomingFlowerZone zone_Growing2 = c.GetZone(map) as Zone_BloomingFlowerZone;
                        Zone_BloomingFlowerZone zone_Growing3 = plant2.Position.GetZone(map) as Zone_BloomingFlowerZone;
            ...
            if (!wantedPlantDef.CanNowPlantAt(c, map) || !PlantUtility.GrowthSeasonNow(c, map, wantedPlantDef) || !pawn.CanReserve(c, 1, -1, null, forced))
            {
                return null;
            }
