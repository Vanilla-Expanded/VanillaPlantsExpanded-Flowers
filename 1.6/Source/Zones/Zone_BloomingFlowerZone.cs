...
{
    public class Zone_BloomingFlowerZone : Zone, IPlantToGrowSettable
    {
        private ThingDef plantDefToGrow = InternalDefOf.VPEF_Plant_RedRoseBush;
        ...
        public Zone_BloomingFlowerZone()
        {


        }

        public Zone_BloomingFlowerZone(ZoneManager zoneManager) : base("VPE_BloomingFlowerZone".Translate(), zoneManager)
        {
        }
        ...
        {
            yield return DesignatorUtility.FindAllowedDesignator<Designator_BloomingFlowerGrowingZone_Expand>();
        }
